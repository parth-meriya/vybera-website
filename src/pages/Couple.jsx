...
const Couple = () => {
  ...
  useEffect(() => {
    getProductsByCategory('couple').then(p => {
      setProducts(p);
      setFiltered(p);
      setLoading(false);
    });
      ...
      <div className="min-h-screen bg-vy-black pt-24 flex items-center justify-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-rose-500/20 to-pink-500/10 border border-rose-500/20 mb-8"
          >
          ...
          <p className="text-vy-border text-xs leading-relaxed max-w-sm mx-auto">
            Matching outfits designed for two. Be the first to know when we drop — follow us on socials.
          </p>
          ...
          <motion.div
            ...
            className="mt-10 mx-auto h-px w-32 bg-gradient-to-r from-transparent via-rose-500/40 to-transparent"
          />
        </motion.div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-vy-black pt-24">
      <SEO
        ...
        description="Shop matching premium streetwear for couples. Coordinated designs, oversized fits, and exclusive drops."
        keywords="couple t-shirts, matching streetwear, couple tees online, premium couple clothes, VYBERA couple collection"
        path="/couple"
      />
      <div className="max-w-screen-xl mx-auto px-6 md:px-12">
        ...
        >
          <div>
            <p className="text-vy-grey text-xs tracking-[0.5em] uppercase mb-1">For Two</p>
